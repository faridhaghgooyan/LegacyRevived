...
<section class="content-wrapper">
    ...
    <div class="page-content">
        ...
        <span class="iransans font-1-rem d-inline">لیست پیام های پیشفرض</span>
        <a href="?c=sms&a=add">+پیام جدید</a>
        <hr>
                ...
                <tr class="d-flex align-items-self">
                    ...
                    <td>
                        ...
                        <abbr title="ویرایش اطلاعات">
                            <a href="?c=sms&a=read&id=<?php echo $sms['id']?>" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                        </abbr>
                        <abbr title="حدف اطلاعات">
                            <a href="?c=sms&a=delete&id=<?php echo $sms['id']?>" class="btn btn-danger btn-sm">
