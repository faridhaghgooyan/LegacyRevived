...
<div class="content-wrapper">
    ...
    <div class="page-content">
        ...
        <form action="index.php?c=services&a=create" method="POST" enctype="multipart/form-data">
            <!-- Main content -->
            <section class="content">
                <div class="row">
                    <i class="fas fa-user-md font-1-rem d-inline"></i>
                    <span class="iransans font-1-rem d-inline">ایجاد خدمت</span>
                    <hr>
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputName" type="text" name="title" value="" required
                                           placeholder="عنوان خدمت ..." class="select">
                                </div>
                                <!-- Service Price -->
                                <div class="form-group">
                                    <label for="inputName">قیمت</label>
                                    <input id="inputName" type="number" name="price" value="" placeholder="مبلغ خدمت به ریال ..." class="select" min="1">
                                </div>
                                <!-- Service Discounted Price -->
                                <div class="form-group">
                                    <label for="inputName">درصد تخفیف</label>
                                    <input id="inputName" type="number" name="disPrice" value="" placeholder="درصد تخفیف خدمت ..." class="select" min="0" max="100" >
                                    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="inputDescription" name="description" required
                                              class="form-control supporter_comment" rows="4" placeholder="توضیحات کامل در خصوص این سرویس..."></textarea>
                                </div>
