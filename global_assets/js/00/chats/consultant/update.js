...
function update_chat_list() {
    ...
    setInterval(function (){
        $.ajax({
            url: "?api=adminChat&a=consultant_new_chats",
            type: "GET",
            dataType: 'json',
            processData: false,
            contentType: false,
    ...
    switch (data['user_type']){
        ...
        case 'consultant':
            switch (data['message_type']){
                case 'text':
                    $('#chatMainBox').append('<p class="admin-chat-box d-inline-block">'+data['message']+'</p>');
                    break;
                case 'image':
        ...
        case 'user':
            switch (data['message_type']){
                case 'text':
                    $('#chatMainBox').append('<p class="user-chat-box d-inline-block">'+data['message']+'</p>');
                    break;
                case 'image':
                    $('#chatMainBox').append('<a href="'+data['path']+'" target="_blank"><img src="'+data['path']+'" data-path="'+data['path']+'" class="user-chat-img shadow" width="200"></a>');
                    break;
            }
            break
    }
