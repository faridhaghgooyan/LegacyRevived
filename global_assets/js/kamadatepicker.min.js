        ...
        n(2),
            (window.kamaDatepicker = function (t, e) {
                ...
                var n,
                    ...
                    u = !1,
                    f = !1,
                    v = ["٠", "١", "٢", "٣", "۴", "۵", "۶", "٧", "٨", "٩", "١٠", "١١", "١٢", "١٣", "١۴", "١۵", "١۶", "١٧", "١٨", "١٩", "٢٠", "٢١", "٢٢", "٢٣", "٢۴", "٢۵", "٢۶", "٢٧", "٢٨", "٢٩", "٣٠", "٣١", "٣٢"];
                (p.placeholder = void 0 !== p.placeholder ? p.placeholder : ""),
                    (p.twodigit = void 0 === p.twodigit || p.twodigit),
                    (p.closeAfterSelect = void 0 === p.closeAfterSelect || p.closeAfterSelect),
                    (p.nextButtonIcon = void 0 !== p.nextButtonIcon && p.nextButtonIcon),
                    (p.previousButtonIcon = void 0 !== p.previousButtonIcon && p.previousButtonIcon),
                    (p.buttonsColor = void 0 !== p.buttonsColor && p.buttonsColor),
                    (p.forceFarsiDigits = void 0 !== p.forceFarsiDigits && p.forceFarsiDigits),
                    (p.markToday = void 0 !== p.markToday && p.markToday),
                    (p.markHolidays = void 0 !== p.markHolidays && p.markHolidays),
                    (p.highlightSelectedDay = void 0 !== p.highlightSelectedDay && p.highlightSelectedDay),
                    ...
                    (p.futureYearsCount = isNaN(p.futureYearsCount) ? 6 : p.futureYearsCount),
                    ...
                    (p.disableHolidays = void 0 !== p.disableHolidays && p.disableHolidays);
                var g = $("#" + t);
                void 0 === g.attr("placeholder") && g.attr("placeholder", p.placeholder);
                g.wrap("<div id='bd-root-" + t + "' style='position: relative;'></div>"), g.after("<div id='bd-main-" + t + "' class='bd-main bd-hide' style='position: absolute; direction: rtl;'></div>");
                var y = $("#bd-main-" + t);
                y.append("<div class='bd-calendar'></div>");
                var b = y.find(".bd-calendar");
                b.append("<div class='bd-title'></div>");
                var h = b.find(".bd-title");
                b.append("<table class='bd-table' dir='rtl' cellspacing='0' cellpadding='0'></table>"),
                    p.swapNextPrev
                        ? h.append("<button id='bd-prev-" + t + "' class='bd-prev' type='button' title='ماه قبلی' data-toggle='tooltip'><span>قبلی</span></button>")
                        : h.append("<button id='bd-next-" + t + "' class='bd-next' type='button' title='ماه بعدی' data-toggle='tooltip'><span>بعدی</span></button>");
                h.append("<div class='bd-dropdown'></div><div class='bd-dropdown'></div>"),
                    h.find(".bd-dropdown:nth-child(2)").append("<select id='bd-month-" + t + "' class='bd-month'></select>"),
                    h.find(".bd-dropdown:nth-child(3)").append("<select id='bd-year-" + t + "' class='bd-year'></select>"),
                    p.swapNextPrev
                        ? h.append("<button id='bd-next-" + t + "' class='bd-next' type='button' title='ماه بعدی' data-toggle='tooltip'><span>بعدی</span></button>")
                        : h.append("<button id='bd-prev-" + t + "' class='bd-prev' type='button' title='ماه قبلی' data-toggle='tooltip'><span>قبلی</span></button>");
                var m = $("#bd-next-" + t);
                ...
                b.find(".bd-table").append("<thead><tr></tr></thead>"),
                    ...
                    b.find(".bd-table").append("<tbody id='bd-table-days-" + t + "' class='bd-table-days'></tbody>");
                ...
                function k() {
                    ...
                    if ((i.offsetHeight, d.offsetHeight, "top" === p.position)) d.style.top = "".concat(-1 * d.offsetHeight, "px");
                    else if ("auto" === p.position) {
                        var l;
                        p.parentId && (l = document.querySelector("#".concat(p.parentId))), (p.parentId && l) || (l = document.querySelector("#bd-root-".concat(t)));
                ...
                g
                    .on("focus", function () {
                        y.removeClass("bd-hide"), p.sync && !1 === f && (F(), (f = !0)), k();
                    })
                    .on("blur", function () {
                        0 == u ? (y.addClass("bd-hide"), (f = !1)) : ((u = !1), g.focus(), event.preventDefault());
                    }),
                    y.on("mousedown", function (t) {
                        u = !0;
                    }),
                    I.on("change", function () {
                        (o = parseInt(this.value)), (l = N(n, o)), (i = A(n, o)), E(l, i), k();
                    }),
                    x.on("change", function () {
                        (n = parseInt(this.value)), (l = N(n, o)), (i = A(n, o)), E(l, i), k();
                    });
                ...
                function B(t, e, n) {
                    return Y(
                        (function (t, e, n) {
                            var o = O(t);
                            return T(o.gy, 3, o.march) + 31 * (e - 1) - j(e, 7) * (e - 7) + n - 1;
                        })(t, e, n)
                    );
                }
                function O(t) {
                    var e,
                        ...
                        r,
                        d,
                        i = [-61, 9, 38, 199, 426, 686, 756, 818, 1111, 1181, 1210, 1635, 2060, 2097, 2192, 2262, 2324, 2394, 2456, 3178],
                        l = i.length,
                        s = t + 621,
                        c = -14,
                        p = i[0];
                    if (p > t || t >= i[l - 1]) throw new Error("Invalid Jalaali year " + t);
                    for (d = 1; l > d && ((n = (e = i[d]) - p), !(e > t)); d += 1) (c = c + 8 * j(n, 33) + j(P(n, 33), 4)), (p = e);
                    return (
                ...
                function T(t, e, n) {
                    var o = j(1461 * (t + j(e - 8, 6) + 100100), 4) + j(153 * P(e + 9, 12) + 2, 5) + n - 34840408;
                    return o - j(3 * j(t + 100100 + j(e - 8, 6), 100), 4) + 752;
                }
                function Y(t) {
                    var e, n, o, a;
                    return (
                        (e = (e = 4 * t + 139361631) + 4 * j(3 * j(4 * t + 183187720, 146097), 4) - 3908),
                ...
                var F = function () {
                        ...
                        ((t = t.split("/")),
                            ...
                            x.val(parseInt(t[0])),
                            x.trigger("change"),
                        p.highlightSelectedDay && (y.find(".bd-selected-day").removeClass("bd-selected-day"), y.find(".day-" + parseInt(t[2])).addClass("bd-selected-day")));
                    },
                    M = function (t) {
                ...
                (s = new Date()),
                    (c = (function (t, e, n) {
                        for (var o = (t = parseInt(t)) - 1600, a = (e = parseInt(e)) - 1, r = (n = parseInt(n)) - 1, d = 365 * o + parseInt((o + 3) / 4) - parseInt((o + 99) / 100) + parseInt((o + 399) / 400), i = 0; a > i; ++i) d += S[i];
                        a > 1 && ((o % 4 == 0 && o % 100 != 0) || o % 400 == 0) && ++d;
                        var l = (d += r) - 79,
                            s = parseInt(l / 12053);
                        l %= 12053;
                        var c = 979 + 33 * s + 4 * parseInt(l / 1461);
                        for ((l %= 1461) >= 366 && ((c += parseInt((l - 1) / 365)), (l = (l - 1) % 365)), i = 0; 11 > i && l >= D[i]; ++i) l -= D[i];
                        return [c, i + 1, l + 1];
                ...
                (a = c[0]),
                    ...
                    (function (t) {
                        ...
                        for (var e = 0; e < p.pastYearsCount + p.futureYearsCount; e++) {
                            ...
                            x.append($("<option>", { value: t - p.pastYearsCount + e, text: n }));
                        }
                    })(n),
                    x.val(n),
                    (l = N(n, o));
                var A = function (t, e) {
                    var n,
                        o = B(t, e, 1);
                    return (o = new Date(o.gy + "/" + o.gm + "/" + o.gd)), (n = o.getDay()) < 6 ? n + 1 : 0;
                };
                i = A(n, o);
                var E = function (e, i) {
                    w.empty();
                    for (var l = 1, s = 1; l <= e; ) {
                        ...
                        for (var c = 0; c < 7; c++) {
                            if (1 == l) for (var u = 0; u < i; ) $("#bd-table-days-" + t + " .tr-1").append($("<td>", { class: "bd-empty-cell" })), u++, c++;
                            if (c < 7 && l <= e) {
                                var f = '<td><button class="day day-' + l + '" type="button">' + (p.forceFarsiDigits ? v[l] : l) + "</button></td>";
                                ...
                                if (p.markHolidays) {
                                    ...
                                    if (6 == c) h = !0;
                                        ...
                                        for (var m = 0; m < p.holidays.length; m++) {
                                            var I = p.holidays[m];
                                            if (((I.year && n === I.year) || !I.year) && l === I.day && o === I.month) {
                                                h = !0;
                                                break;
                                            }
                                        }
                                    if (h) {
                                        ...
                                        if (((f = f.slice(0, x) + " bd-holiday " + f.slice(x)), p.disableHolidays)) {
                    ...
                    if (p.highlightSelectedDay) {
                        var H = g.val();
                        (H = H.split("/"))[0] == n && H[1] == o && (y.find(".bd-selected-day").removeClass("bd-selected-day"), y.find(".day-" + parseInt(H[2])).addClass("bd-selected-day"));
                    }
                };
                g.parent().on("click", "button.day", function () {
                    var t = n + "/" + o + "/" + $(this).attr("class").split(" ")[$(this).attr("class").split(" ").indexOf("day") + 1].split("-")[1];
                    p.twodigit && (t = M(t)),
                        g.val(t),
                        g.trigger("change"),
                    p.closeAfterSelect && ((u = !1), g.trigger("blur")),
                    p.highlightSelectedDay && (y.find(".bd-selected-day").removeClass("bd-selected-day"), $(this).addClass("bd-selected-day"));
                }),
                    m.on("click", function () {
                ...
                E(l, i), "function" == typeof $().modal && $('[data-toggle="tooltip"]').tooltip();
            });
    },
    function (t, e, n) {},
]);
